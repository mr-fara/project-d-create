...
const Footer = () => {
  return (
    ...
    className='py-12 bg-green-50 px-8'>
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 sm:grid-cols-2 gap-8'>
            <div className='space-y-6 mr-14'>
                ...
                <p className='text-para'>D-CREATE is a creative web and design agency since 2022. We build websites, apps, and digital solutions that help businesses grow and succeed online.</p>
            ...
            <div className='space-y-6'>
             ...
             {/* Bottom Bar */}
            <div className="justify-center items-center footer-bottom">
